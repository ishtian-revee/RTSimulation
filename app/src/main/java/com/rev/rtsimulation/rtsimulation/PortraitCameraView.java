        ...
        /* Now set camera parameters */
            try {
                ...
                if (sizes != null) {
                    ...
                    // use turn around values here to get the correct prev size for portrait mode
                    ...
                    // the frame width and height of the super class are used to generate the cached bitmap and they need to be the size of the resulting frame
                    mFrameWidth = params.getPreviewSize().height;
                    mFrameHeight = params.getPreviewSize().width;

                    // the real width and height are the width and height of the frame received in onPreviewFrame
                    int realWidth = mFrameHeight;
                    int realHeight = mFrameWidth;

                    if ((getLayoutParams().width == ActionBar.LayoutParams.MATCH_PARENT) &&
                            (getLayoutParams().height == ActionBar.LayoutParams.MATCH_PARENT)){
